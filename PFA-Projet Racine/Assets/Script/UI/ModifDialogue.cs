...
public class ModifDialogue : MonoBehaviour
{
    ...
    public void modifDialogue1()
    {
        ...
        DialogueTutoriel.instance.lines.Add("J-J-JE CONNAIS 3 TYPES DE GRAINES, LES BUCHERONS, LES MINEURS ET LES PLONGEURS. MAIS ATTENTION, ON N'AIME PAS TOUS LES MEME RESSOURCES !");
    ...
    public void modifDialogue2()
    {
        ...
        DialogueTutoriel.instance.lines.Add("LES CHAMPS SONT ESSENTIEL POUR NOTRE CROISSANCE ! CHAQUES HUMAINS A BESOIN D'UN CHAMP ET CHAQUES CHAMPS A BESOIN D'UN HUMAIN.");
    ...
    public void modifDialogue3()
    {
        ...
        DialogueTutoriel.instance.lines.Add("LES MAISONS NOUS SERVENT D'ENDROIT POUR FAIRE DODO, VOUS POURREZ DONC PLANTER PLUSSSS DE COPAIN. ATTENTION CAR LES BATIMENTS A METIER N'ONT QUE 2 OUTILS MAX POUR LES HUMAINS PLANTES !");
    ...
    {
        DialogueTutoriel.instance.lines.Clear();
        DialogueTutoriel.instance.lines.Add("WAAAAAAAAA VOUS AVEZ RÉUSSI, VIVE NOTRE GRAND CHEFFFFF ! IL EST TROP FOOOOOORT ! VOUS ETES PRET POUR LANCER VOTRE PREMIERE EXPEDITION DE BUCHERON, CLIQUEZ SUR L'ENTREE DE LA FORET POUR ENVOYER VOTRE HUMAIN PLANTE AU TRAVAIL");
        DialogueTutoriel.instance.lines.Add("VOUS POUVEZ AUSSI ME FAIRE PLEINS D'AUTRES COPAINS ! ALLEZ VOIR PAPI POUR VOIR LES GRAINES DE MES FUTUR COPAINS !");
        _GOdialogue.SetActive(true);
    }
}
